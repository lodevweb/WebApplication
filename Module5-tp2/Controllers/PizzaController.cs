...
namespace Module5_tp2.Controllers
{
    public class PizzaController : Controller
    {
        ...
        public ActionResult Create(PizzaViewModel vm)
        {
            try
            {
                //singleordefault l'element récup doit etre unique
                ...
                {
                    vm.Pizza.Id = FakeDb.Instance.Pizzas.Max(x => x.Id) + 1; //problematique liee a l'asynchronisme NePasUtiliserCOUNT !
                }
        ...
        public ActionResult Edit(PizzaViewModel vm)
        {
            try
            {
                ...
                //vm.pizza.pate.id == tuupdate.pate.id
